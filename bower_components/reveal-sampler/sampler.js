        ...
        fetch(file, function(code) {
            ...
            if (options.unindent) {
              ...
              if (indentMatch) {
                ...
                sample = sample.replace(indentPattern, '');
              }
            }
